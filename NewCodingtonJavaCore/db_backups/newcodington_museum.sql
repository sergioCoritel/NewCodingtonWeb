...
CREATE TABLE `museum` (
  ...
  CONSTRAINT `fk_museum_places1` FOREIGN KEY (`id_place`) REFERENCES `places` (`id_place`) ON DELETE CASCADE ON UPDATE NO ACTION
...
-- Dump completed on 2014-12-02  4:03:56

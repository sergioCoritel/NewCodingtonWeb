...
/*function validarUsername(valor) {
	if(Username!=""){
		...
		if (numero<120){ //Si es menor que 120,comprobación exitosa.
			return (true);
		}
		else{
		  var elemento = document.getElementById("errorEdad");//Si es mayor que 120 aparece frase de error.
	      elemento.innerHTML ="*Year is incorrect.";
		  return false;
		 }
		}else{return true;}
} */
